...
export const defaultPermissions: Record<UserRole, Record<string, PermissionLevel>> = {
  gestor: { ...allWrite },
  diretor: { ...allWrite },
  gerente: {
