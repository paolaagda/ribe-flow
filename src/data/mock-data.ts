...
export type PartnerClass = 'A' | 'B' | 'C' | 'D';
...
export interface Partner {
  ...
  averageProduction: number; // centavos — média de produção do ano anterior
}
...
export const mockPartners: Partner[] = [
  { id: 'p1', name: 'Loja Crédito Fácil', razaoSocial: 'Crédito Fácil Ltda', cnpj: '12.345.678/0001-01', address: 'Rua Augusta, 1200 — São Paulo, SP', lat: -23.5505, lng: -46.6333, structures: ['Help', 'Loja balcão'], potential: 'alto', phone: '(11) 3000-1001', contact: 'Roberto Dias', responsibleUserId: 'u4', partnerClass: 'A', averageProduction: 9200000 },
  { id: 'p2', name: 'Financeira Express', razaoSocial: 'Express Financeira S.A.', cnpj: '23.456.789/0001-02', address: 'Av. Paulista, 900 — São Paulo, SP', lat: -23.5615, lng: -46.6559, structures: ['Venda Online', 'Call-center'], potential: 'alto', phone: '(11) 3000-1002', contact: 'Marcia Rocha', responsibleUserId: 'u4', partnerClass: 'A', averageProduction: 8500000 },
  { id: 'p3', name: 'Casa do Empréstimo', razaoSocial: 'Casa do Empréstimo ME', cnpj: '34.567.890/0001-03', address: 'Rua XV de Novembro, 300 — Curitiba, PR', lat: -25.4284, lng: -49.2733, structures: ['Loja balcão'], potential: 'médio', phone: '(41) 3000-1003', contact: 'Fábio Nunes', responsibleUserId: 'u5', partnerClass: 'B', averageProduction: 6200000 },
  { id: 'p4', name: 'Consig Center', razaoSocial: 'Consig Center Ltda', cnpj: '45.678.901/0001-04', address: 'Av. Brasil, 500 — Rio de Janeiro, RJ', lat: -22.9068, lng: -43.1729, structures: ['Help', 'Call-center'], potential: 'alto', phone: '(21) 3000-1004', contact: 'Lúcia Ferreira', responsibleUserId: 'u5', partnerClass: 'A', averageProduction: 7800000 },
  { id: 'p5', name: 'Ponto do Crédito', razaoSocial: 'Ponto do Crédito ME', cnpj: '56.789.012/0001-05', address: 'Rua Halfeld, 150 — Juiz de Fora, MG', lat: -21.7642, lng: -43.3503, structures: ['Loja balcão'], potential: 'baixo', phone: '(32) 3000-1005', contact: 'André Martins', responsibleUserId: 'u6', partnerClass: 'D', averageProduction: 1800000 },
  { id: 'p6', name: 'Mega Financeira', razaoSocial: 'Mega Financeira S.A.', cnpj: '67.890.123/0001-06', address: 'Av. Afonso Pena, 800 — Belo Horizonte, MG', lat: -19.9167, lng: -43.9345, structures: ['Venda Online', 'Help'], potential: 'alto', phone: '(31) 3000-1006', contact: 'Carla Vieira', responsibleUserId: 'u4', partnerClass: 'A', averageProduction: 11000000 },
  { id: 'p7', name: 'Crédito Popular', razaoSocial: 'Crédito Popular Ltda', cnpj: '78.901.234/0001-07', address: 'Av. Goiás, 200 — Goiânia, GO', lat: -16.6869, lng: -49.2648, structures: ['Loja balcão', 'Call-center'], potential: 'médio', phone: '(62) 3000-1007', contact: 'Paulo Ramos', responsibleUserId: 'u6', partnerClass: 'C', averageProduction: 3500000 },
  { id: 'p8', name: 'Solução Financeira', razaoSocial: 'Solução Financeira ME', cnpj: '89.012.345/0001-08', address: 'Rua da Aurora, 50 — Recife, PE', lat: -8.0476, lng: -34.877, structures: ['Help'], potential: 'médio', phone: '(81) 3000-1008', contact: 'Renata Lopes', responsibleUserId: 'u5', partnerClass: 'B', averageProduction: 5500000 },
  { id: 'p9', name: 'Norte Crédito', razaoSocial: 'Norte Crédito Ltda', cnpj: '90.123.456/0001-09', address: 'Av. Djalma Batista, 1100 — Manaus, AM', lat: -3.1190, lng: -60.0217, structures: ['Venda Online'], potential: 'baixo', phone: '(92) 3000-1009', contact: 'Thiago Araújo', responsibleUserId: 'u6', partnerClass: 'D', averageProduction: 0 },
  { id: 'p10', name: 'Sul Empréstimos', razaoSocial: 'Sul Empréstimos S.A.', cnpj: '01.234.567/0001-10', address: 'Rua dos Andradas, 400 — Porto Alegre, RS', lat: -30.0346, lng: -51.2177, structures: ['Loja balcão', 'Help'], potential: 'alto', phone: '(51) 3000-1010', contact: 'Vanessa Castro', responsibleUserId: 'u4', partnerClass: 'A', averageProduction: 9800000 },
  { id: 'p11', name: 'Capital Consig', razaoSocial: 'Capital Consig Ltda', cnpj: '11.223.344/0001-11', address: 'SBS Quadra 2, Brasília, DF', lat: -15.7942, lng: -47.8822, structures: ['Call-center', 'Venda Online'], potential: 'alto', phone: '(61) 3000-1011', contact: 'Marcos Pereira', responsibleUserId: 'u5', partnerClass: 'B', averageProduction: 7200000 },
  { id: 'p12', name: 'Litoral Finanças', razaoSocial: 'Litoral Finanças ME', cnpj: '22.334.455/0001-12', address: 'Av. Atlântica, 600 — Florianópolis, SC', lat: -27.5954, lng: -48.5480, structures: ['Loja balcão'], potential: 'médio', phone: '(48) 3000-1012', contact: 'Aline Barros', responsibleUserId: 'u6', partnerClass: 'C', averageProduction: 2800000 },
  { id: 'p13', name: 'Sertão Crédito', razaoSocial: 'Sertão Crédito ME', cnpj: '33.445.566/0001-13', address: 'Rua Barão do Rio Branco, 80 — Campina Grande, PB', lat: -7.2172, lng: -35.8811, structures: ['Help', 'Loja balcão'], potential: 'baixo', phone: '(83) 3000-1013', contact: 'Diego Souza', responsibleUserId: 'u4', partnerClass: 'D', averageProduction: 1200000 },
  { id: 'p14', name: 'Centro Oeste Finanças', razaoSocial: 'Centro Oeste Finanças Ltda', cnpj: '44.556.677/0001-14', address: 'Av. Mato Grosso, 350 — Campo Grande, MS', lat: -20.4697, lng: -54.6201, structures: ['Call-center'], potential: 'médio', phone: '(67) 3000-1014', contact: 'Priscila Melo', responsibleUserId: 'u5', partnerClass: 'C', averageProduction: 4100000 },
  { id: 'p15', name: 'Prime Consignado', razaoSocial: 'Prime Consignado S.A.', cnpj: '55.667.788/0001-15', address: 'Rua Chile, 120 — Salvador, BA', lat: -12.9714, lng: -38.5124, structures: ['Venda Online', 'Help', 'Loja balcão'], potential: 'alto', phone: '(71) 3000-1015', contact: 'Bruno Teixeira', responsibleUserId: 'u6', partnerClass: 'B', averageProduction: 5100000 },
  // Mock partners within 100km of São Paulo (p1/p2) for map suggestion testing
  { id: 'p16', name: 'Guarulhos Crédito', razaoSocial: 'Guarulhos Crédito Ltda', cnpj: '66.778.899/0001-16', address: 'Av. Tiradentes, 500 — Guarulhos, SP', lat: -23.4538, lng: -46.5333, structures: ['Loja balcão'], potential: 'médio', phone: '(11) 3000-1016', contact: 'Rafael Mendes', responsibleUserId: 'u5', partnerClass: 'A', averageProduction: 6800000 },
  { id: 'p17', name: 'Santos Financeira', razaoSocial: 'Santos Financeira ME', cnpj: '77.889.900/0001-17', address: 'Av. Ana Costa, 300 — Santos, SP', lat: -23.9608, lng: -46.3336, structures: ['Help', 'Call-center'], potential: 'alto', phone: '(13) 3000-1017', contact: 'Camila Rocha', responsibleUserId: 'u4', partnerClass: 'B', averageProduction: 4900000 },
  { id: 'p18', name: 'Campinas Consig', razaoSocial: 'Campinas Consig Ltda', cnpj: '88.990.011/0001-18', address: 'Rua Barão de Jaguara, 200 — Campinas, SP', lat: -22.9099, lng: -47.0626, structures: ['Venda Online', 'Loja balcão'], potential: 'médio', phone: '(19) 3000-1018', contact: 'Eduardo Gomes', responsibleUserId: 'u6', partnerClass: 'C', averageProduction: 3200000 },
];
