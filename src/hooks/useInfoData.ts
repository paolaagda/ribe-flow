...
const bankLogos: Record<string, string> = {
  ...
  Crefaz: 'https://ui-avatars.com/api/?name=Crefaz&background=1e40af&color=fff&size=128&bold=true&length=3',
  Crefisa: 'https://ui-avatars.com/api/?name=Crefisa&background=0d9488&color=fff&size=128&bold=true&length=3',
  Daycoval: 'https://ui-avatars.com/api/?name=Daycoval&background=0369a1&color=fff&size=128&bold=true&length=3',
  Digio: 'https://ui-avatars.com/api/?name=Digio&background=7c3aed&color=fff&size=128&bold=true&length=3',
  Finanto: 'https://ui-avatars.com/api/?name=Finanto&background=059669&color=fff&size=128&bold=true&length=3',
  Icred: 'https://ui-avatars.com/api/?name=Icred&background=dc2626&color=fff&size=128&bold=true&length=3',
  Itaú: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Banco_Ita%C3%BA_logo.svg/512px-Banco_Ita%C3%BA_logo.svg.png',
  Mercantil: 'https://ui-avatars.com/api/?name=Mercantil&background=b45309&color=fff&size=128&bold=true&length=3',
  'Novo Saque': 'https://ui-avatars.com/api/?name=Novo+Saque&background=4f46e5&color=fff&size=128&bold=true&length=2',
  PAN: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Logo_Banco_Pan.svg/512px-Logo_Banco_Pan.svg.png',
  Paulista: 'https://ui-avatars.com/api/?name=Paulista&background=be185d&color=fff&size=128&bold=true&length=3',
  'Riber Seguros': 'https://ui-avatars.com/api/?name=Riber+Seguros&background=16a34a&color=fff&size=128&bold=true&length=2',
  Safra: 'https://ui-avatars.com/api/?name=Safra&background=1d4ed8&color=fff&size=128&bold=true&length=3',
